...
#include <jomfft/cdft/core/impl/TwiddleDft_B10.h>
...
void NS(CDftCore_TwiddleDft_B10_1Test)() {
  ...
  (NS(CDftCore_TwiddleDft_B10_1), true, 10, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_B10_2Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_B10_2), true, 10, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_B10_4Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_B10_4), true, 10, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_B10_8Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_B10_8), true, 10, 8);
}
#endif
