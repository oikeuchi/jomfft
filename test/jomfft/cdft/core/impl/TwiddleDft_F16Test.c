...
#include <jomfft/cdft/core/impl/TwiddleDft_F16.h>
...
void NS(CDftCore_TwiddleDft_F16_1Test)() {
  ...
  (NS(CDftCore_TwiddleDft_F16_1), false, 16, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_F16_2Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_F16_2), false, 16, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_F16_4Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_F16_4), false, 16, 8);
}
#endif
...
void NS(CDftCore_TwiddleDft_F16_8Test)() {
  NS(CDftCore_TwiddleDftFunctionTest)
  (NS(CDftCore_TwiddleDft_F16_8), false, 16, 8);
}
#endif
