...
#include "../../cdft/singleton/StrideBatchDft.h"
...
static struct NS(RealToComplexFunction)
  ...
  return NS(RDft_EvenSizeOuterBatchDft_F_new)(
      data->data,
      NS(CDftSingleton_StrideBatchDft_new)(data->data, false, data->dft_size,
                                           batch_size, 1, x_stride_1, 1,
                                           y_stride),
...
static struct NS(ComplexToRealFunction)
  ...
  return NS(RDft_EvenSizeOuterBatchDft_B_new)(
      data->data,
      NS(CDftSingleton_StrideBatchDft_new)(data->data, true, data->dft_size,
                                           batch_size, 1, x_stride, 1,
                                           y_stride_1),
